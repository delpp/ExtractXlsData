...
import extract.excel.data.model.ReadWriteTools;
...
public class WindowController<T> {
	...
	@FXML private void setFile() throws Exception{
		...
		fileChooser.setInitialDirectory(new File(System.getProperty("user.home"), "/Desktop/readXLS/teksty"));
	...
	@FXML private void writePresets() throws Exception{
		final FileChooser fileChooser = new FileChooser();
		fileChooser.setInitialDirectory(new File(System.getProperty("user.home"), "/Desktop/readXLS"));
